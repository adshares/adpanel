...
import { SiteSmartLinkDialogComponent } from './dialogs/site-smart-link-dialog/site-smart-link-dialog.component';
...
@NgModule({
  ...
  declarations: [...publisherComponents, ...editSiteComponents, SiteSmartLinkDialogComponent],
})
