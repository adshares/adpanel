  ...
  tooltipPageRankInfo(pageRankInfo: string): string {
    ...
    switch (pageRankInfo) {
      ...
      case pageRankInfoEnum.LOW_CTR:
        info =
          'The click-through rate is too low. Please try placing ad units in a more visible places. You can also check if you are using the most popular ad unit sizes.';
        break;
