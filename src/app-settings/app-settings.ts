import { ChartColors } from '../app/models/chart/chart-colors.model';
import { ChartOptions } from '../app/models/chart/chart-options.model';
...
export { appSettings, chartOptions, chartColors };
